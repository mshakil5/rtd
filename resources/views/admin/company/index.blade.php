            ...
            <form id="createThisForm" action="{{ route('admin.companyDetails') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name" name="company_name" value="{{$data->company_name}}" required>
                        @error('company_name')
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('business_name') is-invalid @enderror" id="business_name" name="business_name" value="{{$data->business_name}}">
                        @error('business_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-4 d-none">
                        ...
                        <input type="number" class="form-control @error('vat_percent') is-invalid @enderror" id="vat_percent" name="vat_percent" value="{{$data->vat_percent}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 d-none">
                        <div class="form-group">
                        <label>Bank</label>
                        <input type="text" class="form-control @error('bank') is-invalid @enderror" id="bank" name="bank" value="{{$data->bank}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 d-none">
                        ...
                        <input type="text" class="form-control @error('account_number') is-invalid @enderror" id="account_number" name="account_number" value="{{$data->account_number}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 d-none">
                        ...
                        <input type="text" class="form-control @error('sort_code') is-invalid @enderror" id="sort_code" name="sort_code" value="{{$data->sort_code}}">
                        </div>
                    </div>
                 ...
                 <!-- Breakfast -->
                    <div class="col-sm-2">
                        ...
                        <input type="time" class="form-control" name="breakfast_start" value="{{ $data->breakfast_start ?? '08:00' }}">
                    </div>
                    <div class="col-sm-2">
                        <label>Breakfast End</label>
                        <input type="time" class="form-control" name="breakfast_end" value="{{ $data->breakfast_end ?? '11:00' }}">
                    </div>

                    <!-- Lunch & Dinner -->
                    <div class="col-sm-2">
                        <label>Lunch/Dinner Start</label>
                        <input type="time" class="form-control" name="lunch_dinner_start" value="{{ $data->lunch_dinner_start ?? '12:00' }}">
                    </div>
                    <div class="col-sm-2">
                        <label>Lunch/Dinner End</label>
                        <input type="time" class="form-control" name="lunch_dinner_end" value="{{ $data->lunch_dinner_end ?? '21:00' }}">
                    </div>

                    <!-- Event Booking -->
                    <div class="col-sm-2">
                        <label>Event Booking Start</label>
                        <input type="time" class="form-control" name="event_booking_start" value="{{ $data->event_booking_start ?? '07:00' }}">
                    </div>
                    <div class="col-sm-2">
                        <label>Event Booking End</label>
                        <input type="time" class="form-control" name="event_booking_end" value="{{ $data->event_booking_end ?? '02:00' }}">
                    </div>
