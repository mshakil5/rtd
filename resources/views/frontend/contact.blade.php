        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="contact-main-wrapper">
                <div class="map-wrapper">
                    <iframe src="{{ $company->google_map ?? '' }}" width="100%" height="100%" style="border:0;"
                    ...
                    <div class="contact-cards-container" data-aos="fade-up" data-aos-delay="300">
                        ...
                        @if ($company->whatsapp)
                            <div class="contact-card">
                                ...
                                <div class="contact-text">
                                    <h4>WhatsApp</h4>
                                    <p><a href="https://wa.me/{{ $company->whatsapp }}"
                                            target="_blank">{{ $company->whatsapp }}</a></p>
                                </div>
                            </div>
                        @endif
                    </div>
                        ...
                        <form action="{{ route('contact.store') }}" method="post" class="php-email-form">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" name="company"
                                    ...
                                    placeholder="Company (If Applicable)" value="{{ old('company') }}">
                                @error('company')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-submit mt-3">
                                ...
                                <div id="loading-text" class="alert alert-info d-none mt-2">
