...
class FrontendController extends Controller
{
    public function index()
    {
      ...
      $products = Product::where('status', 1)->select('id', 'title', 'icon', 'short_description', 'slug')->orderByRaw('sl = 0, sl ASC')->orderBy('id', 'desc')->limit(4)->get();
    ...
    public function menu()
    {
       ...
       $banner =  Banner::firstOrCreate(['page' => 'Menu']);
       return view('frontend.menu', compact('menu', 'banner'));
    }
    ...
    {
        $banner = Banner::firstOrCreate(['page' => 'Gallery']);
        return view('frontend.gallery', compact('banner'));
    }

    public function services()
    {      
        $banner = Banner::firstOrCreate(['page' => 'Service']);
        $products = Product::where('status', 1)->select('id', 'title', 'image', 'short_description', 'slug')->orderByRaw('sl = 0, sl ASC')->orderBy('id', 'desc')->get();
        return view('frontend.services', compact('banner', 'products'));    
    }

    public function serviceDetails($slug)
    {
        $banner = Banner::firstOrCreate(['page' => 'Service']);
        $service = Product::where('slug', $slug)->firstOrFail();
        ...
        return view('frontend.service-details', compact('service', 'banner'));
    }
    ...
    public function bookNow()
    {
        ...
        return view('frontend.book-now', compact('banner', 'company'));
    }
